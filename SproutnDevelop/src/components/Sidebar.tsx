...
import { HomeIcon, FolderPlusIcon, MessageCircleIcon, SettingsIcon, UserIcon, UsersIcon, FileTextIcon, PencilIcon, LayoutIcon, BookOpenIcon, CodeIcon } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  return <div className="hidden md:flex md:flex-col md:w-48 md:bg-charcoal-500 md:text-white">
      <div className="flex items-center justify-center h-16 bg-charcoal-600">
        <img src="/IMG_8336.png" alt="Logo" className="h-10" />
      </div>
