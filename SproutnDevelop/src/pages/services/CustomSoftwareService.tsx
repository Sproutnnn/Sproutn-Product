...
import { ArrowRightIcon, CheckIcon, ServerIcon } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-12">
              ...
              <p className="text-xl mb-8">
                Develop tailor-made software solutions that address your unique
                business challenges. We create custom applications that
                streamline operations and boost efficiency.
              </p>
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link to="/login" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-[#434C54] bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white transition-colors">
                  Start Your Project
            ...
            <div className="md:w-1/2 mt-10 md:mt-0">
              <div className="relative">
                <div className="bg-white rounded-lg shadow-xl p-6 transform rotate-3">
                  <ServerIcon className="h-16 w-16 text-[#434C54] mb-4" />
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We develop bespoke software applications that solve your specific
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            description: 'Custom ERP solutions that integrate and manage your core business processes in a single system.'
          }, {
            title: 'Customer Relationship Management',
            description: 'Tailored CRM applications that help you manage customer interactions and improve relationships.'
          }, {
            title: 'Business Process Automation',
            description: 'Custom workflows and automation tools that reduce manual tasks and increase operational efficiency.'
          }, {
            title: 'Data Analytics Solutions',
            description: 'Bespoke analytics platforms that transform your data into actionable business insights.'
          }, {
            title: 'Legacy System Modernization',
            description: 'Update and transform your outdated systems into modern, scalable applications.'
          }, {
            title: 'Integration Solutions',
            description: 'Custom middleware and APIs that connect your various business systems and data sources.'
