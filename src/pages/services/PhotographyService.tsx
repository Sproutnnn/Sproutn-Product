          ...
          <div className="mt-16 max-w-3xl mx-auto relative">
            <div className="bg-charcoal-700/70 backdrop-blur-sm p-6 rounded-xl border border-charcoal-600 shadow-2xl">
              ...
              <div className="text-gray-300">
                <p className="mb-2">
                  <span className="text-primary-400">$</span> Setting up product
                  photography studio
                </p>
                <p className="mb-2">
                  <span className="text-primary-400">&gt;</span> Adjusting
                  lighting for optimal product display
                </p>
                <p className="mb-2">
                  <span className="text-primary-400">&gt;</span> Capturing
