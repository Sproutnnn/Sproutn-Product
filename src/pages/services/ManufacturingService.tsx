          ...
          <div className="mt-16 max-w-3xl mx-auto relative">
            <div className="bg-charcoal-700/70 backdrop-blur-sm p-6 rounded-xl border border-charcoal-600 shadow-2xl">
              ...
              <div className="text-gray-300">
                <p className="mb-2">
                  <span className="text-primary-400">$</span> Initializing
                  production planning
                </p>
                <p className="mb-2">
                  <span className="text-primary-400">&gt;</span> Coordinating
                  materials procurement
                </p>
                <p className="mb-2">
                  <span className="text-primary-400">&gt;</span> Implementing
      ...
      <section className="py-20 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            description: 'We develop detailed production plans including timelines and resource allocation'
          }, {
            step: '2',
            ...
            description: 'We conduct comprehensive quality checks throughout production'
          }, {
            step: '5',
            title: 'Packaging & Shipping',
            description: 'We handle packaging, labeling, and coordinate shipping to your destinations'
